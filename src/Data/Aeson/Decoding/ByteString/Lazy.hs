...
lbsToTokens bs0 = goT bs0 id where
    ...
    tokenCase W8.LOWER_N       bs  _   k
        | Just bs1 <- stripPrefix (LBSC.pack "ull") 3 bs  = TkLit LitNull (k bs1)
    tokenCase W8.LOWER_T       bs  _   k
        | Just bs1 <- stripPrefix (LBSC.pack "rue") 3 bs  = TkLit LitTrue (k bs1)
    tokenCase W8.LOWER_F       bs  _   k
        | Just bs1 <- stripPrefix (LBSC.pack "alse") 4 bs = TkLit LitFalse (k bs1)
